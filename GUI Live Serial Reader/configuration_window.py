...
from configuration_manager import save_configurations, delete_configuration
...
class configurationWindow(ctk.CTk):
    def __init__(self, name):
        ...
        file.add_command(label="Delete", command=lambda: delete_configuration(current_config))
    ...
    def rename_popup(self, current_config):
        ...
        rename_popup.place(x=self.winfo_pointerx() - self.winfo_rootx(),
