...
class configurationWindow(ctk.CTk):
    def __init__(self, name):
        ...
        other_settings.add_command(label="View Configuration Details", command=None)
    ...
    def baudWarning(self, baud_value):
        open_baud_warning1(baud_value)

    def comWarning(self, com_value):
        open_com_warning1(com_value)

    def csvWarning(self, csv_name):
