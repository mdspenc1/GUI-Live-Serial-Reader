...
class line(mlines.Line2D):
    ...
    def update_line_style(self, **new_kwargs):
        for key, value in new_kwargs.items():
            ...
            if callable(setter):
                ...
                print("meow")
        self._original_kwargs.update(new_kwargs)
...
class add_basic_line(ctk.CTkToplevel):
    def __init__(self, config):
        ...
        serial_names = [serial_var.variable_name for serial_var in self.config.serial_variables]
