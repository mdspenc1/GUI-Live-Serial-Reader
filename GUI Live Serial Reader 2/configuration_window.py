...
class configurationWindow(ctk.CTk):
    def __init__(self, name):
        ...
        run_list.add_command(label="RUN!", command=self.run_live_plotting)
        run_list.add_command(label="STOP!", command=self.stop_live_plotting)
